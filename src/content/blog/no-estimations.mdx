...
Instead of estimating the time required for each story, simply count the number of stories and track how many are completed each week. Use this data to project release dates: `Projected End Date = (Total Stories / Stories Completed per Week) + Start Date`
